...
public class AppoinmentControllerImpl {
	...
	/*@RequestMapping(value = "/join/inner", method = RequestMethod.GET, produces = "application/json")
	public ResponseEntity<List<JoinDto>> getLeftInnerData() {
		return new ResponseEntity<List<JoinDto>>(appoinmentService.innerJoinData(), HttpStatus.OK);
	}*/
