...
public class Master {
	...
	public Master(String name_affiliate, Integer age, String mail, Integer id_appoinment, Date date, String hour,
			String test_name) {
		super();
	...
	public Master(Integer id_affiliate, String name_affiliate, Integer age, String mail, Integer id_appoinment,
			Date date, String hour, String test_name) {
		super();
	...
	public String toString() {
		return "Master [id_affiliate=" + id_affiliate + ", name_affiliate=" + name_affiliate + ", age=" + age
				+ ", mail=" + mail + ", id_appoinment=" + id_appoinment + ", date=" + date + ", hour=" + hour
				+ ", test_name=" + test_name + "]";
	}
